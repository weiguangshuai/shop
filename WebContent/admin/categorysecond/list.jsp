	...
	<HEAD>
		...
		<script type="text/javascript">
			function addCategorySecond(){
				window.location.href = "${pageContext.request.contextPath}/adminCategorySecond_addPage";
			}
		</script>
	</HEAD>
	<body>
...
&#28155;&#21152;
								...
								<s:iterator var="c" value="pagebean.list" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/adminCategorySecond_edit.action?csid=<s:property value="#c.csid"/>">
					...
					<tr align="center">
						<td class="ta_01" align="center" bgColor="#afd1f3">
							...
							<a href="${pageContext.request.contextPath }/adminCategorySecond_findAll?page=<s:property value="pagebean.total"/>">尾页</a>
							</s:if>
						</TD>
					</tr>
				</TBODY>
