		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<s:actionerror />
					<form id="registerForm" action="user_regist" method="post" novalidate="novalidate" onsubmit="return checkForm();">
						<table>
							<tbody><tr>
								<th>
								...
								<td>
									<input type="text" id="username" name="user.username" class="text" maxlength="20" onblur="checkUsername()"/>
									<span id="span1"></span>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" autocomplete="off"><img id="checkImg" 
											class="captchaImage" src="${pageContext.request.contextPath}/checkImg" onclick="change()" title="点击更换验证码">
										</span>
									</td>
								</tr>
							<tr>
