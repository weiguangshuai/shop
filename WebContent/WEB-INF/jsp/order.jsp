		...
		<div class="span24">
			...
			<div class="step step1">
				...
				<table>
					...
					<s:iterator value="model.orderItems" id="orderItem">
						<tr>
							<td width="60">
			...
			<form id="orderForm" action="${pageContext.request.contextPath}/order_pay" method="post">
				<input type="hidden" name="oid" value="<s:property value="model.oid"/>"/>
				<div class="span24">
					<p>
							收货地址：<input name="address" type="text" value="<s:property value="#session.existuser.address"/>" style="width:350px" />
								<br />
							收货人&nbsp;&nbsp;&nbsp;：<input name="name" type="text" value="<s:property value="#session.existuser.name"/>" style="width:150px" />
								<br /> 
							联系方式：<input name="phone" type="text"value="<s:property value="#session.existuser.address"/>" style="width:150px" />
